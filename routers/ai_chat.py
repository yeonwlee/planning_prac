...
proposal_chatbot = CustomChatBot(kind_of_model='gpt-4o', model_name='proposal', prompt_concept='기획서 작성', detail_prompt='해당 내용에 적합하게 기획서를 작성해줘', temperature=0.1, history=True)
